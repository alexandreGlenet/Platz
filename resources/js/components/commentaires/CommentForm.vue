...
#stripes {
    background: url(../../../../public/img/stripes.svg) no-repeat;
    position: absolute;
    width: 27px;
    height: 20px;
    right: 15px;
...
#fleche-nav-3 {
    float: left;
    margin-top: 26px;
    background: url(../../../../public/img/fleche-nav.svg) no-repeat;
    width: 5px;
    height: 10px;
    margin-left: 5px;
}
...
#cross-menu {
    ...
    right: 25px;
    margin-top: 25px;
    background: url(../../../../public/img/cross-menu.svg) no-repeat;
    cursor: pointer;
}
...
.image-reply-post-2 {
    background: url(../../../../public/img/avatar-2.png) no-repeat;
}
...
#tip_newsletter_input {
    ...
    box-shadow: none;
    outline: 0;
    background: url(../../../../public/img/icon-newsletter.svg) no-repeat 10px 9px;
    margin-left: 20px;
...
#tip_search_input {
    ...
    outline: 0;
    margin: 0;
    background: url(../../../../public/img/icon-search.svg) no-repeat 12px 7px;
    vertical-align: center;
    margin-left: -40px;
    background-color: #FFF;
}
